...
If the micro image does not suit your requirements, you can use hhttps://catalog.redhat.com/software/containers/ubi9-minimal/61832888c0d15aff4912fe0d[ubi9-minimal].
